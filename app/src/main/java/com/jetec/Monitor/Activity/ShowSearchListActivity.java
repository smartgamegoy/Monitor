...
import com.jetec.Monitor.SupportFunction.ViewAdapter.SearchListViewAdapter;
...
public class ShowSearchListActivity extends AppCompatActivity implements SearchListener {
    ...
    private String BID, newListjson;
